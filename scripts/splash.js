...
module.exports.onStart = (scene, gui) => {
  ...
  new BABYLON.ArcRotateCamera("Camera", -Math.PI / 2, 0, 10, BABYLON.Vector3.Zero(), scene);
  ...
  logo.diffuseTexture = new BABYLON.Texture('/home/mizucoffee/working_dir/yuntan/skins/Yuki-Skin/images/yuntan_logo.png', scene);
